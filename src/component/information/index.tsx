  ...
  return (
    <>
      <div className="info-card">
        ...
        <div className="content">
          (원래 문구)참석이 어려워 직접 축하해주지 못하는
          (수정 문구)너무도 이른 시간이지만 와주셔서 감사합니다
          <br />
          (원래 문구)분들을 위해 계좌번호를 기재하였습니다.
          (수정 문구)분들을 위해 계좌번호를 기재하였습니다.
          <br />
          (원래 문구)넓은 마음으로 양해 부탁드립니다.
          (수정 문구)넓은 마음으로 양해 부탁드립니다.
        </div>
